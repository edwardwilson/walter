...
#
# Commands:
#   hubot b <jobNumber> - builds the job specified by jobNumber. List jobs to get number.
#   hubot build <job> - builds the specified Jenkins job
#   hubot build <job>, <params> - builds the specified Jenkins job with parameters as key=value&key2=value2
        ...
        if err
          ...
          try
            ...
            req.get() (err, res, body) ->
              ...
              msg.send "Last build: #{jobstatus}, #{jobdate}\n"
...
module.exports = (robot) ->
  robot.respond /j?(?:enkins)? build ([\w\.\-_ ]+)(, (.+))?/i, (msg) ->
    if robot.auth.hasRole(msg.envelope.user, 'development')
      ...
      msg.reply "Sorry you can't ask me to build, you're not in the development team"
  ...
  robot.respond /status of ([\w\.\-_ ]+) build/i, (msg) ->
    jenkinsDescribe(msg)
